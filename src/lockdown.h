...
int lockdown_start_service(lockdown_t* lockdown, const char* service, lockdownd_service_descriptor_t* descriptor);
int lockdown_start_service2(lockdown_t* lockdown, const char* service, lockdownd_service_descriptor_t* descriptor, int warn_on_fail);
